...
$$
\begin{aligned}
\Large Si &= \Large  98.82 - (0.93 \cdot Na) - (0.99 \cdot Mg) - (1.00 \cdot Al) \\ &- \Large (1.14 \cdot K) - (0.98 \cdot Ca) - (0.79 \cdot Ba) + (1.01 \cdot Fe)
\end{aligned}
$$
...
that are silicon in the glass will increases by 1.01%. (Certain chemical properties?)
