...
data.frame( R2 = R2(predictions, glass$Si),
...
data.frame( R2 = R2(predictions, test.data$Si),
...
glass_model5 <- train(Si ~ Na + Mg + Al + K + Ca + Ba + Fe + type, data = glass, 
